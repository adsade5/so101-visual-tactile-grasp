...
| 项目 | 证据 |
|---|---|
| 机器人 | SO-101 6-DOF follower arm |
| 中间件 | ROS2 Lyrical with `rmw_zenoh_cpp` |
| 感知 | OpenCV ArUco 物体定位与 workspace-to-base 坐标变换 |
| IK / Planning | 5 关节阻尼最小二乘 IK、多初值回退、预抓取、7 段笛卡尔下降 |
| 触觉 | FlexiTac 12x32 阵列，COM8 直连串口，2 Mbaud |
| 真机结果 | 视觉-触觉抓取与抬升链路真机验收 PASS |
| Demo | [完整演示视频](./demo.mp4)：视觉定位 -> 坐标变换 -> IK/规划 -> 触觉接触停止 -> 抬升 |
