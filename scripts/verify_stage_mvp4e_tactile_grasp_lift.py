...
def main() -> int:
    ...
    cases.append(case("server_no_contact_no_lift_reason", "gripper_closed_without_tactile_contact" in visual))
    ...
    cases.append(case("visual_lift_only_after_contact", "tactile_contact_confirmed" in visual and "tactile_contact_stop" in visual))
